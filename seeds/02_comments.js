  ...
  return knex('comments').del()
    .then(function () {
      ...
      return knex('comments').insert([
        {id: 1, user_name: 'shaquille.oatmeal', user_image: 'https://m.media-amazon.com/images/M/MV5BMmRhYTgzMjQtNDcxMC00MTA4LWFlYTUtOTJkYTE4ODlmMWZkXkEyXkFqcGdeQXVyODQ3NDAyNDU@._V1_UY268_CR147,0,182,268_AL_.jpg', date: new Date('04/20/2020'), comment: ''},
